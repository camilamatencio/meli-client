        ...
        return (
            <nav className="nav__search">
                <Container>
                    <Row>
                        <Col xs={2} md={1}>
                            <Link to='/'><img className="search__logo" src={logoML} alt="Mercado Libre"/></Link>
                        </Col>
                        <Col xs={10} md={11}>
                            <input className="search__box" type="text" name="query" placeholder="Nunca dejes de buscar"/>
                            <button className="search__button" type="submit" onClick={this.onSubmit}><img src={ic_Search} alt="Buscar"></img></button>
                        </Col>
                    </Row>
                </Container>
            </nav>
