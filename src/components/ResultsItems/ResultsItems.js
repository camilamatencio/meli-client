        ...
        return (
            <Row className="results__row">
                <Col className="results__col1" xs= "auto">
                    <Link className="results__link" to={`/items/${this.props.item.id}`}><img className="results__image" src={this.props.item.picture} alt=""/></Link>
                </Col>
                <Col className="results__col2">
                    <h2 className="results__price">$ {this.props.item.price.amount}{this.props.item.free_shipping ? <img className="shipping__image" src={ic_shipping} alt=""/> : ''}</h2>
